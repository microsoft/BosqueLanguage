...
- [5 Expressions](#5-Expressions)
  ...
  - [5.8 None-Chaining](#5.8-None-Chaining)
...
Bosque has provided _named arguments_ along with _rest_ and _spread_ operators. These can be used to perform simple and powerful data manipulation as part of invocations and constructor operations ([5.1 Arguments](#5.1-Arguments)).
