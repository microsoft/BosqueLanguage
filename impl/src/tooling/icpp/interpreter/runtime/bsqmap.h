...
#define MAP_STORE_RESULT_REPR(R, COUNT, SL) SLPTR_STORE_UNION_INLINE_TYPE(SLPTR_LOAD_HEAP_TYPE(R), SL); SLPTR_STORE_CONTENTS_AS(BSQNat, SLPTR_LOAD_UNION_INLINE_DATAPTR(SL), COUNT); SLPTR_STORE_CONTENTS_AS_GENERIC_HEAPOBJ(SLPTR_LOAD_UNION_INLINE_DATAPTR(SL) + 8, R)
