...
//Header word layout
//high [RC - 40 bits] [MARK - 1 bit] [YOUNG - 1 bit] [BUMP_SPACE - 1 bit] [EAGER_RC - 1 bit] [TYPEID - 20 bits]
...
#define GC_META_INFO_MASK (GC_MARK_BIT | GC_YOUNG_BIT | GC_BUMP_SPACE_BIT | GC_EAGER_RC_BIT)
...
#define GC_EXTRACT_META_INFO(W) (W & GC_META_INFO_MASK)
...
#define GC_TEST_IS_BUMP_SPACE(W) (W & GC_BUMP_SPACE_BIT)
#define GC_TEST_IS_EAGER_RC(W) (W & GC_EAGER_RC_BIT)

#define GC_CLEAR_MARK_BIT(W) (W & (GC_RC_MASK | GC_YOUNG_BIT | GC_BUMP_SPACE_BIT | GC_EAGER_RC_BIT | GC_TYPE_ID_MASK))
#define GC_SET_MARK_BIT(W) (W | GC_MARK_BIT)

#define GC_CLEAR_EAGER_RC_BIT(W) (W & (GC_RC_MASK | GC_YOUNG_BIT | GC_TYPE_ID_MASK))
...
#define GC_INIT_EAGER_RC(ADDR, TID) GC_SET_META_DATA_WORD(ADDR, GC_RC_ZERO | GC_YOUNG_BIT | GC_EAGER_RC_BIT | TID)
#define GC_INIT_RC(ADDR, TID) GC_SET_META_DATA_WORD(ADDR, GC_RC_ONE | GC_YOUNG_BIT | TID)
...
#define GC_UPDATE_OLD_RC_EAGER(ADDR, W) GC_SET_META_DATA_WORD(ADDR, GC_EXTRACT_RC(W) | GC_EAGER_RC_BIT | GC_EXTRACT_TYPEID(W))
#define GC_UPDATE_OLD_RC_ROOT_REF(ADDR, W) GC_SET_META_DATA_WORD(ADDR, GC_RC_ZERO | GC_MARK_BIT | GC_EXTRACT_TYPEID(W))
#define GC_UPDATE_OLD_RC_HEAP_REF(ADDR, W) GC_SET_META_DATA_WORD(ADDR, GC_RC_ONE | GC_EXTRACT_TYPEID(W))
