...
function assignSSA(op: MIROp, ssastate: SSAState): MIROp {
    switch (op.tag) {
        ...
        case MIROpTag.MIRLogicAction: {
            ...
            cc.trgt = convertToSSA(cc.trgt, ssastate.booltype, ssastate);
            return op;
        }
