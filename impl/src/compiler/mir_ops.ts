...
enum MIROpTag {
    ...
    MIRConstructorPrimaryCollectionOneElement = "MIRConstructorPrimaryCollectionOneElement",
    ...
    static jparse(jobj: any & { tag: string }): MIROp {
        switch (jobj.tag) {
            ...
            case MIROpTag.MIRConstructorPrimaryCollectionOneElement:
                return MIRConstructorPrimaryCollectionOneElement.jparse(jobj);
...
class MIRInvokeFixedFunction extends MIROp {
    ...
    getUsedGlobals(): MIRGlobalVariable[] { return globalsOnlyHelper(this.sguard !== undefined ? [...this.sguard.getUsedGlobals(), ...this.args] : [...this.args]); }
    getModVars(): MIRRegisterArgument[] { return [this.trgt]; }
...
class MIRInvokeVirtualFunction extends MIROp {
    ...
    constructor(sinfo: SourceInfo, resultType: MIRResolvedTypeKey, vresolve: MIRVirtualMethodKey, shortname: string, rcvrlayouttype: MIRResolvedTypeKey, rcvrflowtype: MIRResolvedTypeKey, args: MIRArgument[], optmask: string | undefined, trgt: MIRRegisterArgument) {
    ...
    getUsedGlobals(): MIRGlobalVariable[] { return globalsOnlyHelper([...this.args]); }
    getModVars(): MIRRegisterArgument[] { return [this.trgt]; }
    ...
    static jparse(jobj: any): MIROp {
        return new MIRInvokeVirtualFunction(jparsesinfo(jobj.sinfo), jobj.resultType, jobj.vresolve, jobj.shortname, jobj.rcvrlayouttype, jobj.rcvrflowtype, jobj.args.map((arg: any) => MIRArgument.jparse(arg)), jobj.optmask, MIRRegisterArgument.jparse(jobj.trgt));
    }
}
...
class MIRInvokeVirtualOperator extends MIROp {
    ...
    constructor(sinfo: SourceInfo, resultType: MIRResolvedTypeKey, vresolve: MIRVirtualMethodKey, shortname: string, args: { arglayouttype: MIRResolvedTypeKey, argflowtype: MIRResolvedTypeKey, arg: MIRArgument }[], trgt: MIRRegisterArgument) {
    ...
    getUsedGlobals(): MIRGlobalVariable[] { return globalsOnlyHelper(this.args.map((arg) => arg.arg)); }
    getModVars(): MIRRegisterArgument[] { return [this.trgt]; }
...
class MIRConstructorRecord extends MIROp {
    ...
    getUsedGlobals(): MIRGlobalVariable[] { return globalsOnlyHelper(this.args.map((tv) => tv[1])); }
    getModVars(): MIRRegisterArgument[] { return [this.trgt]; }
...
class MIREphemeralListExtend extends MIROp {
    ...
    getUsedGlobals(): MIRGlobalVariable[] { return globalsOnlyHelper([this.arg, ...this.ext]); }
    getModVars(): MIRRegisterArgument[] { return [this.trgt]; }
...
class MIRConstructorPrimaryCollectionOneElement extends MIROp {
    trgt: MIRRegisterArgument;
    readonly tkey: MIRResolvedTypeKey;
    arg: [MIRResolvedTypeKey, MIRArgument];

    constructor(sinfo: SourceInfo, tkey: MIRResolvedTypeKey, arg: [MIRResolvedTypeKey, MIRArgument], trgt: MIRRegisterArgument) {
        super(MIROpTag.MIRConstructorPrimaryCollectionOneElement, sinfo);
    ...
    jemit(): object {
        return { ...this.jbemit(), trgt: this.trgt.jemit(), tkey: this.tkey, arg: [this.arg[0], this.arg[1].jemit()] };
    }

    static jparse(jobj: any): MIROp {
        return new MIRConstructorPrimaryCollectionOneElement(jparsesinfo(jobj.sinfo), jobj.tkey, [jobj.arg[0], MIRArgument.jparse(jobj.arg[1])], MIRRegisterArgument.jparse(jobj.trgt));
    }
}
...
class MIRBinKeyEq extends MIROp {
    ...
    getUsedGlobals(): MIRGlobalVariable[] { return globalsOnlyHelper(this.sguard !== undefined ? [this.lhs, this.rhs, ...this.sguard.getUsedGlobals()] : [this.lhs, this.rhs]); }
    getModVars(): MIRRegisterArgument[] { return [this.trgt]; }
...
class MIRBinKeyLess extends MIROp {
    ...
    constructor(sinfo: SourceInfo, lhslayouttype: MIRResolvedTypeKey, lhs: MIRArgument, rhslayouttype: MIRResolvedTypeKey, rhs: MIRArgument, cmptype: MIRResolvedTypeKey, trgt: MIRRegisterArgument, lhsflowtype: MIRResolvedTypeKey, rhsflowtype: MIRResolvedTypeKey) {
    ...
    getUsedGlobals(): MIRGlobalVariable[] { return globalsOnlyHelper([this.lhs, this.rhs]); }
    getModVars(): MIRRegisterArgument[] { return [this.trgt]; }
    ...
    jemit(): object {
        return { ...this.jbemit(), trgt: this.trgt.jemit(), cmptype: this.cmptype, lhslayouttype: this.lhslayouttype, lhs: this.lhs.jemit(), rhslayouttype: this.rhslayouttype, rhs: this.rhs.jemit(), lhsflowtype: this.lhsflowtype, rhsflowtype: this.rhsflowtype };
    }

    static jparse(jobj: any): MIROp {
        return new MIRBinKeyLess(jparsesinfo(jobj.sinfo), jobj.lhslayouttype, MIRArgument.jparse(jobj.lhs), jobj.rhslayouttype, MIRArgument.jparse(jobj.rhs), jobj.cmptype, MIRRegisterArgument.jparse(jobj.trgt), jobj.lhsflowtype, jobj.rhsflowtype);
    }
}
...
class MIRIsTypeOf extends MIROp {
    ...
    getUsedGlobals(): MIRGlobalVariable[] { return globalsOnlyHelper(this.sguard !== undefined ? [this.arg, ...this.sguard.getUsedGlobals()] : [this.arg]); }
    getModVars(): MIRRegisterArgument[] { return [this.trgt]; }
...
class MIRRegisterAssign extends MIROp {
    ...
    getUsedGlobals(): MIRGlobalVariable[] { return globalsOnlyHelper(this.sguard !== undefined ? [this.src, ...this.sguard.getUsedGlobals()] : [this.src]); }
    getModVars(): MIRRegisterArgument[] { return [this.trgt]; }
...
export {
    ...
    MIRConstructorPrimaryCollectionEmpty, MIRConstructorPrimaryCollectionOneElement, MIRConstructorPrimaryCollectionSingletons,
